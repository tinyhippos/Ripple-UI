...
event.on("KeyboardOpened", function () {
    _apply("keyboardOpened");
});

event.on("KeyboardOpening", function () {
    _apply("keyboardOpening");
});

event.on("KeyboardClosed", function () {
    _apply("keyboardClosed");
});

event.on("KeyboardClosing", function () {
    _apply("keyboardClosing");
});

event.on("KeyboardPosition", function (yPos) {
    _apply("keyboardPosition", [yPos]);
});
