...
describe("webworks pim appointment", function () {
    var appointment = require('ripple/platform/webworks/handset/2.0.0/server/appointment'),
        Appointment = require('ripple/platform/webworks/handset/2.0.0/client/Appointment'),
